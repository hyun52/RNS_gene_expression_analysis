...
# Output: Tree-ordered heatmaps saved in PDF format.
...
output_dir <- "Relative_heatmaps_PDF"
...
for (i in seq_along(gene_trees)) {
  ...
  out_file <- file.path(output_dir, paste0("heatmap_", clean_name, ".pdf"))
...
cat("All PDF heatmaps were generated successfully.\n")
